...
public class Server extends Connection {
	...
	public static void main(String args[]) {		
		...
		try {
			...
			DatagramPacket request = handleClientConnection(fullAddress, aSocket);
	...
	private static DatagramPacket handleClientConnection(String fullAddress, DatagramSocket aSocket) throws IOException {
